...
void FftHistogram::connectNode( audio::GainNodeRef _ref ) { _ref >> monitorSpectralNode; }
void FftHistogram::connectNode( audio::BufferPlayerNodeRef _ref ) { _ref >> monitorSpectralNode; }
...
int FftHistogram::getSize() { return fftData.data.size(); }
...
bool FftHistogram::setUseNormVals( bool _use ) { useNormVals = _use; };
